...
@section('title', 'Cập Nhật Vai Trò - ClinicHub')

@section('content')
    <div class="container-fluid py-3">
        <div class="d-flex justify-content-between align-items-center mb-4 px-4">
            <div>
                <h5 class="mb-1 fw-bold text-dark">Chỉnh Sửa Vai Trò (Edit Role)</h5>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 12px;">
            <div class="card-body p-4">
                <form action="{{ route('role.update', $role->id) }}" method="POST">
                    ...
                    @method('PUT')
                    <div class="mb-4">
                        <label for="name" class="form-label text-dark">Tên Vai Trò</label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $role->name) }}" placeholder="Ví dụ: admin, doctor, receptionist..." required>
                        @error('name')
                    ...
                    <div class="mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <label class="form-label fw-semibold text-dark mb-0">Phân Quyền Hạn (Permissions)</label>

                            {{-- Nút Check All cho toàn bộ hệ thống --}}
                            ...
                            <div class="card border border-light-subtle shadow-sm mb-4 permission-group-card" style="border-radius: 12px;">
                                ...
                                <div class="card-header bg-light py-2.5 px-4 d-flex justify-content-between align-items-center" style="border-top-left-radius: 12px; border-top-right-radius: 12px;">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-0">
                                        ...
                                        <label class="form-check-label text-secondary small fw-semibold cursor-pointer mb-0" for="check-all-{{ $groupName }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateGlobalState() {
                ...
                globalCheckAll.checked = (totalChecked === allPermCheckboxes.length);
            }
            ...
            function updateGroupState(card) {
                ...
                if (groupCheckAll) {
                    groupCheckAll.checked = (totalItems === totalCheckedItems);
                }
            }
